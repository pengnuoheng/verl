...
MINDSPEED_CONFIG=(
    ...
    actor_rollout_ref.actor.mindspeed.fsdp_kwargs.distributed.ulysses_parallel_size=${SP_SIZE}
    '+actor_rollout_ref.actor.mindspeed.fsdp_kwargs.distributed.fsdp_plan.apply_modules={model.visual.blocks.\{*\}:{},model.visual.patch_embed:{},model.visual.pos_embed:{},model.language_model.embed_tokens:{},model.language_model.layers.\{*\}:{},lm_head:{}}'
    ...
    actor_rollout_ref.actor.mindspeed.fsdp_kwargs.distributed.ep_plan.dispatcher=${ep_dispatcher}
